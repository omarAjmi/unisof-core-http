...
public interface SerializerAdapter {
    ...
    default <T> T deserialize(final InputStream inputStream, final Type type, final SerializerEncoding encoding)
         ...
         */
        return deserialize(converterStream.toString(StandardCharsets.UTF_8), type, encoding);
    }
     ...
     * {@link com.unisoft.core.http.rest.ResponseBase} returned by java proxy method corresponding to the REST API.
     * e.g.
